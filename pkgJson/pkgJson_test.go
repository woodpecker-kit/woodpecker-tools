...
func TestInitPkgJsonVersion(t *testing.T) {
	...
	versionGoStyle := GetPackageJsonVersionGoStyleKeepSelect(false)
...
func TestGetPackageJsonVersionGoStyle(t *testing.T) {
	...
	goNewStyle := GetPackageJsonVersionGoStyleKeepSelect(true)
	assert.Equal(t, "go-1.2.3", goNewStyle)
	SetVersionPrefixGoStyle("")
	assert.Equal(t, "1.2.3", GetPackageJsonVersionGoStyleKeepSelect(true))
}
...
func TestGetPackageJsonAuthor(t *testing.T) {
	...
	assert.Equal(t, "woodpecker-kit", GetPackageJsonAuthor().Name)
	assert.Equal(t, "woodpecker-kitgmppt@gmail.com", GetPackageJsonAuthor().Email)
}
